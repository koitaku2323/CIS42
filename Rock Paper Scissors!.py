...
def game_loop():
	...
	while run2: 
		...
		score(winPlayer,110,35)
		score(lostPlayer,110,65)
		score(totalGames,180,95)
		score(ties,227,50)
		pg.display.update()
...
def resultsCheck():
	...
	while run3:
		...
		score(winPlayer,350,130)
		score(lostPlayer,350,190)
		score(totalGames,390,250)
		score((winPlayer/totalGames) * 100,375,310)
		pg.display.update()
